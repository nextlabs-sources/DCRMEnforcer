...
// But changed by NEXTLABS (Replace alll the List<object> with List<object>)
...
public partial class condition {
    ...
    //change to List from array by Nextlabs
...
public partial class FetchAttributeType {
    ...
    //add by NXL
    private RowAggregateType rowaggregateField;
    private bool rowAggregateSet = false;

    [System.Xml.Serialization.XmlAttributeAttribute()]
    public string rowaggregate
    {
        get
        {
            if (rowAggregateSet)
            {
                return rowaggregateField.ToString();
            }
            return null;
        }
        set {
            ...
            {
                rowAggregateSet = false;
            }
            else { 
                this.rowaggregateField = RowAggregateType.countchildren;
                this.rowAggregateSet = true;
                }
        }
    }
...
public partial class FetchType {
    ...
    /// <summary>
    /// Q:why we set its type is string?
    /// A:smetime when we get xml from query , it's value is "Ture" ,cannot convent to Boolean, so we set it type is string
    /// </summary>
    private string returntotalrecordcountField;
    ...
    [System.Xml.Serialization.XmlAttributeAttribute()]
    //[System.ComponentModel.DefaultValueAttribute(false)]
    public string returntotalrecordcount {
        get {
